...
function Home(){
   ...
   <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
      ...
      <section className="pt-44 pb-30 px-6 text-center" >
     <motion.h1
     ...
     >
       ...
       >
         Describe Your Idea And Let AI Generate a Modern, Responsive, Prodution-ready Website.
       </motion.p>
  ...
  >
    ...
    <p className="text-sm text-zinc-400">
      YourWebAI builds real websites - clean code, animations,
    ...
    <footer className="border-t border-white/10 py-10 text-center text-sm text-zinc-500">
        &copy;{new Date().getFullYear()} YourWeb.AI
    </footer>
